...
oModuleReport.ExportToFile("Y Parameter Table 1", "/beegfs/scratch/joelhoward/QSMSimulations/QSMTests/SWIFT500um/feedlineCouplingR1/Y11R1_Results.csv", False)
oProject.Save()
