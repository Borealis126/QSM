...
oModuleReport.ExportToFile("Y Parameter Table 1", "/beegfs/scratch/joelhoward/QSMSimulations/QSMSource/WendianValidationTesting/SWIFT500um/lumpedR0/Y11R0_Results.csv", False)
oProject.Save()
