...
oModuleReport.ExportToFile("Y Parameter Table 1", "/beegfs/scratch/joelhoward/QSMSimulations/QSMSource/WendianValidationTesting/SWIFT500um/lumpedR1/YRestR1_Results.csv", False)
oProject.Save()
