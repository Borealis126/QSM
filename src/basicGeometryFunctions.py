...
def vertexBoundary(vertex,boundary,resolution):#Create a circular set of points a distance "boundary" away from vertex. 
    boundaryPointsList=[]
    centerX=vertex[0]
    centerY=vertex[1]
...
def arcLength(radius,angle):
    return radius*angle
def nextPointSegment(point,angle,length):#Build segment from an initial point, angle, and distance. Return the second point in the segment.  
